...
,
  ...
  { category: "Professions", thai: "หมอ", en: "doctor" },
  { category: "Professions", thai: "พยาบาล", en: "nurse" },
  { category: "Professions", thai: "ทันตแพทย์", en: "dentist" },
  { category: "Professions", thai: "เภสัชกร", en: "pharmacist" },
  { category: "Professions", thai: "สัตวแพทย์", en: "veterinarian" },
  { category: "Professions", thai: "ศัลยแพทย์", en: "surgeon" },
  { category: "Professions", thai: "นักจิตวิทยา", en: "psychologist" },
  { category: "Professions", thai: "ครู", en: "teacher" },
  { category: "Professions", thai: "อาจารย์", en: "university lecturer / professor" },
  { category: "Professions", thai: "นักเรียน", en: "student (school)" },
  { category: "Professions", thai: "นักศึกษา", en: "student (university)" },
  { category: "Professions", thai: "วิศวกร", en: "engineer" },
  { category: "Professions", thai: "สถาปนิก", en: "architect" },
  { category: "Professions", thai: "นักวิทยาศาสตร์", en: "scientist" },
  { category: "Professions", thai: "โปรแกรมเมอร์", en: "programmer" },
  { category: "Professions", thai: "นักออกแบบ", en: "designer" },
  { category: "Professions", thai: "นักบัญชี", en: "accountant" },
  { category: "Professions", thai: "ทนายความ", en: "lawyer" },
  { category: "Professions", thai: "ผู้พิพากษา", en: "judge" },
  { category: "Professions", thai: "นักข่าว", en: "journalist" },
  { category: "Professions", thai: "นักเขียน", en: "writer / author" },
  { category: "Professions", thai: "นักแปล", en: "translator" },
  { category: "Professions", thai: "ช่างภาพ", en: "photographer" },
  { category: "Professions", thai: "ผู้กำกับ", en: "director (film/theatre)" },
  { category: "Professions", thai: "นักแสดง", en: "actor / performer" },
  { category: "Professions", thai: "นักดนตรี", en: "musician" },
  { category: "Professions", thai: "นักร้อง", en: "singer" },
  { category: "Professions", thai: "เชฟ", en: "chef" },
  { category: "Professions", thai: "พ่อครัว", en: "cook (male)" },
  { category: "Professions", thai: "แม่ครัว", en: "cook (female)" },
  { category: "Professions", thai: "พนักงานเสิร์ฟ", en: "waiter / server" },
  { category: "Professions", thai: "บาร์เทนเดอร์", en: "bartender" },
  { category: "Professions", thai: "พนักงานต้อนรับ", en: "receptionist / host" },
  { category: "Professions", thai: "มัคคุเทศก์", en: "tour guide" },
  { category: "Professions", thai: "นักบิน", en: "pilot" },
  { category: "Professions", thai: "พนักงานต้อนรับบนเครื่องบิน", en: "flight attendant" },
  { category: "Professions", thai: "คนขับรถ", en: "driver" },
  { category: "Professions", thai: "ทหาร", en: "soldier / military" },
  { category: "Professions", thai: "นักดับเพลิง", en: "firefighter" },
  { category: "Professions", thai: "ชาวนา", en: "farmer" },
  { category: "Professions", thai: "ชาวประมง", en: "fisherman" },
  { category: "Professions", thai: "ช่างไม้", en: "carpenter" },
  { category: "Professions", thai: "ช่างไฟฟ้า", en: "electrician" },
  { category: "Professions", thai: "ช่างประปา", en: "plumber" },
  { category: "Professions", thai: "ช่างยนต์", en: "mechanic" },
  { category: "Professions", thai: "นักกีฬา", en: "athlete / sportsperson" },
  { category: "Professions", thai: "โค้ช", en: "coach" },
  { category: "Professions", thai: "นักธุรกิจ", en: "businessman / businesswoman" },
  { category: "Professions", thai: "ผู้จัดการ", en: "manager" },
  { category: "Clothing", thai: "เสื้อผ้า", en: "clothes / clothing" },
  { category: "Clothing", thai: "เสื้อยืด", en: "t-shirt" },
  { category: "Clothing", thai: "เสื้อเชิ้ต", en: "dress shirt / button-up shirt" },
  { category: "Clothing", thai: "เสื้อกล้าม", en: "tank top / vest" },
  { category: "Clothing", thai: "เสื้อแจ็กเก็ต", en: "jacket" },
  { category: "Clothing", thai: "เสื้อกันหนาว", en: "sweater / jumper" },
  { category: "Clothing", thai: "เสื้อฮู้ด", en: "hoodie" },
  { category: "Clothing", thai: "เสื้อสูท", en: "suit jacket / blazer" },
  { category: "Clothing", thai: "สูท", en: "suit (full)" },
  { category: "Clothing", thai: "กางเกงขาสั้น", en: "shorts" },
  { category: "Clothing", thai: "กางเกงยีนส์", en: "jeans" },
  { category: "Clothing", thai: "กางเกงในชาย", en: "underwear (male)" },
  { category: "Clothing", thai: "กระโปรงยาว", en: "long skirt / maxi skirt" },
  { category: "Clothing", thai: "ชุดนอน", en: "pyjamas / nightwear" },
  { category: "Clothing", thai: "ชุดว่ายน้ำ", en: "swimsuit / swimwear" },
  { category: "Clothing", thai: "ชุดกีฬา", en: "sportswear / tracksuit" },
  { category: "Clothing", thai: "ชุดสูท", en: "business suit (full outfit)" },
  { category: "Clothing", thai: "ชุดไทย", en: "traditional Thai dress" },
  { category: "Clothing", thai: "ผ้าซิ่น", en: "traditional Thai wraparound skirt" },
  { category: "Clothing", thai: "ผ้าขาวม้า", en: "traditional Thai checked cloth" },
  { category: "Clothing", thai: "ถุงน่อง", en: "stockings / tights" },
  { category: "Clothing", thai: "รองเท้าผ้าใบ", en: "trainers / sneakers" },
  { category: "Clothing", thai: "รองเท้าแตะ", en: "sandals / flip-flops" },
  { category: "Clothing", thai: "รองเท้าส้นสูง", en: "high heels" },
  { category: "Clothing", thai: "รองเท้าบูท", en: "boots" },
  { category: "Clothing", thai: "หมวกไหมพรม", en: "beanie / woolly hat" },
  { category: "Clothing", thai: "ถุงมือ", en: "gloves" },
  { category: "Clothing", thai: "แว่นกันแดด", en: "sunglasses" },
  { category: "Clothing", thai: "ผ้ากันเปื้อน", en: "apron" },
  { category: "Clothing", thai: "ชุดชั้นใน", en: "underwear / lingerie" },
  { category: "Clothing", thai: "บรา", en: "bra" },
  { category: "Clothing", thai: "เน็คไท", en: "necktie" },
  { category: "Clothing", thai: "โบว์ไท", en: "bow tie" },
  { category: "Clothing", thai: "ปลอกคอ", en: "collar" },
  { category: "Clothing", thai: "เสื้อชั้นใน", en: "undershirt / inner top" },
  { category: "Clothing", thai: "กระเป๋า", en: "bag (general)" },
  { category: "Clothing", thai: "เสื้อเชิ้ต", en: "shirt (button-up)" },
  { category: "Clothing", thai: "เสื้อแจ็คเก็ต", en: "jacket" },
  { category: "Clothing", thai: "กางเกงใน", en: "underwear / underpants" },
  { category: "Clothing", thai: "กางเกงขายาว", en: "long trousers / full-length pants" },
  { category: "Clothing", thai: "กระโปรงสั้น", en: "short skirt / mini skirt" },
  { category: "Clothing", thai: "ชุดราตรี", en: "evening gown / formal dress" },
  { category: "Clothing", thai: "รองเท้าหนัง", en: "leather shoes" }
];
